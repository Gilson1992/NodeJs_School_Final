...
router.get('/:cpf', autorizationMiddleware, async (req: Request, res: Response) => {
...
router.delete('/delete/:cpf', autorizationMiddleware, async (req: Request, res: Response) => {
    try {
...
router.put('/:cpf', autorizationMiddleware, async (req: Request, res: Response) => {
